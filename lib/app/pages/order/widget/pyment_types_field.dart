...
class PymentTypesField extends StatelessWidget {
  final List<PaymentTypeModel> paymentTypes;
  final ValueChanged<int> valueChager;
  final bool valid;
  final String valueSelected;

  const PymentTypesField({
    super.key,
    required this.paymentTypes,
    required this.valueChager,
    required this.valid,
      ...
      child: Column(
        ...
        children: [
          ...
          SmartSelect<String>.single(
            ...
            onChange: (selected) {
              valueChager(int.parse(selected.value));
            },
